...
namespace ENBpresetAssistant.ValidationRules
{
    public class PresetNotRepeatValidationRule : ValidationRule
    {
        public override ValidationResult Validate(object value, CultureInfo cultureInfo)
        {
            ...
            if (FileHelper.PathAvailableOrNot(Data.SettingsData.StoragePath + Data.ID.Dir_Preset + "\\" + value.ToString())) return new ValidationResult(false, LocalizedHelper.GetLocalizedString("Validation_Repeat", Data.ID.StrRes_Common));
